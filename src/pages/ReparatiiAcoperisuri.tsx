...
export default function ReparatiiAcoperisuri() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="font-montserrat text-3xl md:text-4xl lg:text-5xl font-bold text-navy mb-6">
                De Ce {serviceData.title} cu Akcon?
              </h2>
      ...
      <ProcessStepsSection processSteps={serviceData.processSteps} />

      <section className="py-16 md:py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8">
            <h2 className="font-montserrat text-3xl md:text-4xl lg:text-5xl font-bold text-navy mb-4">
              Proiecte de Reparații Personalizate
            </h2>
            <p className="font-open-sans text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto">
              Fiecare acoperiș are nevoi unice de reparație. Nu avem un singur caz tipic de prezentat - fiecare proiect de reparație este diferit!
            </p>
          </div>

          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border-l-4 border-gold">
            <h3 className="font-montserrat text-2xl md:text-3xl font-bold text-navy mb-6 text-center">
              Ai nevoie de reparații acoperișuri?
            </h3>

            <div className="flex flex-col gap-4 mb-8">
              <button
                onClick={scrollToContact}
                className="w-full bg-gold text-white px-8 py-5 rounded-lg font-montserrat text-lg md:text-xl font-semibold hover:bg-gold-hover transition-all duration-300 shadow-lg hover:shadow-gold/50 hover:scale-105 flex items-center justify-center gap-3"
              >
              ...
              <a
                href={`tel:+40${companyData.phone.replace(/\s/g, '').replace(/^0/, '')}`}
                className="w-full bg-navy text-white px-8 py-5 rounded-lg font-montserrat text-lg md:text-xl font-semibold hover:bg-navy-light transition-all duration-300 shadow-lg hover:scale-105 flex items-center justify-center gap-3"
              >
            ...
            <div className="space-y-4 text-left">
              <h4 className="font-montserrat text-xl font-bold text-navy flex items-center gap-2">
              ...
              <div className="space-y-3 pl-7">
                <div className="flex items-start gap-3">
                  ...
                  <p className="font-open-sans text-gray-700">Evaluare gratuită la fața locului</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-gold flex-shrink-0 mt-1" />
                  <p className="font-open-sans text-gray-700">Diagnostic complet probleme acoperiș</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-gold flex-shrink-0 mt-1" />
                  <p className="font-open-sans text-gray-700">Ofertă personalizată pentru reparațiile tale</p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-gold flex-shrink-0 mt-1" />
                  <p className="font-open-sans text-gray-700">Soluții rapide și eficiente</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="font-montserrat font-bold text-navy">Răspuns rapid în 24 ore</p>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <CheckCircle className="w-8 h-8 text-gold" />
                  <p className="font-montserrat font-bold text-navy">Evaluare gratuită, fără obligații</p>
                </div>
                <div className="flex flex-col items-center gap-2">
                  <CheckCircle className="w-8 h-8 text-gold" />
                  <p className="font-montserrat font-bold text-navy">Experiență în toate tipurile de reparații</p>
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div ref={elementRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
