...
export default function AboutTabs() {
  ...
  const tabs: TabContent[] = [
    ...
    },
    {
      ...
      content: (
        <div>
          <h2 className="font-montserrat text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-glow-white">
            Cristian - Viziune Tânără, Experiență Solidă
          </h2>
          <p className="font-open-sans text-xl mb-6 opacity-95 leading-body">
    ...
    },
    {
      ...
      content: (
        <div>
          <h2 className="font-montserrat text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-glow-white">
            Experiență + Inovație = Rezultate Excepționale
          </h2>
          <p className="font-open-sans text-xl mb-6 opacity-95 leading-body">
    ...
    },
    {
      ...
      content: (
        <div>
          <h2 className="font-montserrat text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-glow-white">
            Patru Generații, O Singură Promisiune: Calitate
          </h2>
          <p className="font-open-sans text-xl mb-6 opacity-95 leading-body">
          ...
          <div className="space-y-6 mb-6">
            <div>
              ...
              <p className="font-open-sans text-base opacity-90 leading-body">
                Bunicii stabilesc reputația pentru meșteșug tradițional și fiabilitate în Alba Iulia și împrejurimi.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="font-open-sans text-base opacity-90 leading-body">
                Tatăl lui Cristi extinde afacerea, profesionalizează echipa și construiește relații de lungă durată cu clienții.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="font-open-sans text-base opacity-90 leading-body">
                Cristian, actualul proprietar și CEO, aduce viziune modernă, soluții inovatoare și tehnologii noi, păstrând în același timp valorile familiale.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 mb-6">
            <p className="font-montserrat text-2xl font-bold text-gold mb-4">
              Aproape 50 de Ani de Experiență Combinată
            </p>
            <p className="font-open-sans text-base opacity-90 leading-body mb-3">
              De-a lungul a patru generații, AKCON a:
            </p>
            <ul className="font-open-sans text-base opacity-90 leading-body space-y-2">
              ...
              <li className="flex items-start">
                <span className="text-gold mr-2">✅</span>
                <span>Construit case pentru generații de familii din Alba</span>
              </li>
              <li className="flex items-start">
                <span className="text-gold mr-2">✅</span>
                <span>Evoluat de la metode tradiționale la soluții moderne</span>
              </li>
              <li className="flex items-start">
                <span className="text-gold mr-2">✅</span>
                <span>Menținut același angajament față de calitate și integritate</span>
              </li>
            </ul>
          </div>

          <p className="font-open-sans text-lg font-semibold text-gold mb-2">
            Tradiție + Inovație = Încrederea Ta
          </p>
          <p className="font-open-sans text-base opacity-90 leading-body">
            Respectăm înțelepciunea trecutului, dar îmbrățișăm progresul viitorului. Fiecare proiect AKCON beneficiază de experiența cumulată a patru generații și leadership-ul inovator al lui Cristian.
          </p>
        </div>
      ),
  ...
  return (
    <section
      id="despre"
      className="relative py-20 bg-gradient-to-br from-navy via-navy-light to-navy text-white overflow-hidden"
    >
